...
class BoardController extends Controller
{
	...
	{
		$this->get_database()->query('UPDATE data SET message_count = message_count + 1');
	}
	...
	{
		return $this->get_database()->query('SELECT message_count FROM data')
	...
	{
		return $this->get_database()->query('SELECT * FROM boards')
	...
	{
		$stmt = $this->get_database()->prepare('DELETE FROM boards WHERE id = ? LIMIT 1');
