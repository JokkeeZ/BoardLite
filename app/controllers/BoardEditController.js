app.controller('BoardEditController', function($scope, $routeParams, ajaxRequest) {
    ...
    $scope.updateBoard = function() {
        ...
        ajaxRequest.updateBoard($routeParams.id, $scope.name, $scope.desc, $scope.prefix, $scope.tag)
            .success(function(response) {
            $scope.updateSuccess = response.status;
        });
    }
});
